package app.parkipedia.ui.home;
...
import app.parkipedia.LoginActivity;
import app.parkipedia.R;
import app.parkipedia.SingleTask;
import app.parkipedia.adapter.ModuleAdapter;
import app.parkipedia.model.Book;
import app.parkipedia.model.Feedback;
import app.parkipedia.model.Module;
...
public class HomeFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    private void parkingBookStatus(boolean status) {
        ...
        ((SingleTask) getActivity().getApplication()).getParkingDatabaseReference().child(profile.getAddress()).child(profile.getUid() + "/bookstatus").setValue(status).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
