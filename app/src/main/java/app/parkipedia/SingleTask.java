...
import app.parkipedia.listener.LocationService;
import app.parkipedia.util.GpsUtils;
...
public class SingleTask extends Application {
    ...
    public void onCreate() {
        ...
        registerReceiver(broadcastReceiver, new IntentFilter("app.parkipedia.listener.cutomlocation"));
